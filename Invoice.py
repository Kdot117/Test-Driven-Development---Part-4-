class Invoice:
    ...
    def totalOrderQuantity(self, products):
        totalOrderQuantity: int = 0
        for k, v in products.items():
            totalOrderQuantity += (int(v['qnt'] + int(v['qnt']))) - 5
    ...
    def totalDiscountPercent(self, products):
        totalDiscountPercent: int = 0
        for k, v in products.items():
            totalDiscountPercent += (int(v['discount'] + int(v['discount']) + int(v['discount'])))
